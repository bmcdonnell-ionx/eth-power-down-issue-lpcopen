...
STATIC const PINMUX_GRP_T pinmuxing[] = {
	...
	/* ADC */
	{0x0, 23, (IOCON_FUNC1 | IOCON_MODE_INACT | IOCON_ADMODE_EN)},
	/* DAC */
	...
	/* JOYSTICK */
	{0x5,  0, (IOCON_FUNC0 | IOCON_MODE_INACT)}, /* JOYSTICK_LEFT  */
	{0x5,  1, (IOCON_FUNC0 | IOCON_MODE_INACT)}, /* JOYSTICK_DOWN  */
	{0x5,  2, (IOCON_FUNC0 | IOCON_MODE_INACT)}, /* JOYSTICK_UP    */
	{0x5,  3, (IOCON_FUNC0 | IOCON_MODE_INACT)}, /* JOYSTICK_PRESS */
	{0x5,  4, (IOCON_FUNC0 | IOCON_MODE_INACT)}, /* JOYSTICK_RIGHT */

	/* FIXME NOT COMPLETE */

	/* LEDs */
	{0x1, 18, (IOCON_FUNC0 | IOCON_MODE_INACT)},                    /* QSB LED1 */
	{0x0, 13, (IOCON_FUNC0 | IOCON_MODE_INACT | IOCON_DIGMODE_EN)}, /* QSB LED2 */
	{0x1, 13, (IOCON_FUNC0 | IOCON_MODE_INACT)},                    /* QSB LED3 */
	{0x2, 19, (IOCON_FUNC0 | IOCON_MODE_INACT)},                    /* QSB LED4 */
	{0x1, 11, (IOCON_FUNC0 | IOCON_MODE_INACT)},                    /* BB  RED RGB */
	{0x1,  5, (IOCON_FUNC0 | IOCON_MODE_INACT | IOCON_DIGMODE_EN)}, /* BB  GREEN RGB */
	{0x1,  7, (IOCON_FUNC0 | IOCON_MODE_INACT | IOCON_DIGMODE_EN)}, /* BB  BLUE RGB */
};
